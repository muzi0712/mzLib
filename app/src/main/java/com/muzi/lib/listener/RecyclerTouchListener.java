...
public class RecyclerTouchListener implements RecyclerView.OnItemTouchListener, OnActivityTouchListener {
    ...
    public RecyclerTouchListener(Activity a, RecyclerView recyclerView) {
        ...
        unSwipeableRows = new ArrayList<Integer>();
        unClickableRows = new ArrayList<Integer>();
        independentViews = new ArrayList<Integer>();
        optionViews = new ArrayList<Integer>();
        fadeViews = new ArrayList<Integer>();
...
//        mSwipeListener = listener;
    ...
    public RecyclerTouchListener setIndependentViews(Integer... viewIds) {
        this.independentViews = new ArrayList<Integer>(Arrays.asList(viewIds));
        return this;
    }

    public RecyclerTouchListener setUnClickableRows(Integer... rows) {
        this.unClickableRows = new ArrayList<Integer>(Arrays.asList(rows));
        return this;
    }
    ...
    public RecyclerTouchListener setSwipeOptionViews(Integer... viewIds) {
        this.optionViews = new ArrayList<Integer>(Arrays.asList(viewIds));
        return this;
    }

    public RecyclerTouchListener setUnSwipeableRows(Integer... rows) {
        this.unSwipeableRows = new ArrayList<Integer>(Arrays.asList(rows));
        return this;
    }

    // Set views which are faded out as fg is opened
    public RecyclerTouchListener setViewsToFade(Integer... viewIds) {
        this.fadeViews = new ArrayList<Integer>(Arrays.asList(viewIds));
        return this;
    }
